...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#dcf6c9] text-[#061e20]" style={{ fontFamily: "PressStart" }}>
      ...
      <div className="px-4 sm:px-16 pt-8 pb-28 space-y-16" >
        <div className="sm:flex sm:h-58 sm:px-32">
          ...
          <div className="sm:w-1/2" >
            <Image src={img1} alt="Lumions" className="h-60 w-96 mx-auto mt-6 sm:mt-0" />
          </div>
        </div>
        ...
        <div className="sm:flex justify-center items-center gap-20" >
          ...
          <div>
            <div className="flex flex-col justify-center items-center mb-12 sm:mb-0" >
        ...
        <div className="sm:flex justify-between px-12 text-xs leading-relaxed sm:text-sm space-y-12 sm:space-y-0">
          <div className="sm:w-1/4 flex flex-col items-center text-center gap-6" >
            <p>Mint your Eggs</p>
        ...
        <div className="text-center text-xs sm:text-sm leading-relaxed" >
